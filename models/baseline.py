...
class Baseline(nn.Module):
    ...
    def __init__(self, im_size=(3, 56, 56)):
        ...
        self.conv5 = nn.Conv2d(128, 128, kernel_size=(3, 3), stride=2)
        self.conv6 = nn.Conv2d(128, 128, kernel_size=(3, 3))
        self.conv7 = nn.Conv2d(128, 256, kernel_size=(3, 3), stride=2) 
        self.conv8 = nn.Conv2d(256, 512, kernel_size=(4, 4)) 
